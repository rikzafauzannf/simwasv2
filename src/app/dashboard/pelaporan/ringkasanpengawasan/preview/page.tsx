              ...
              <Table className="min-w-full border-collapse border border-gray-300 text-left">
                <thead className="bg-gray-200">
                  <tr className="text-center align-middle">
                    ...
                    <th className="border border-gray-300 p-2">NOMOR DAN TANGGAL SP</th>
                    <th className="border border-gray-300 p-2">URAIAN,AUDITAN, NOMOR DAN TGL LHP</th>
                    <th className="border border-gray-300 p-2">NO</th>
                    <th className="border border-gray-300 p-2">KONDISI/TEMUAN</th>
                    <th className="border border-gray-300 p-2" colSpan={2}>KODE TEMUAN</th>
                    <th className="border border-gray-300 p-2" colSpan={2}>REKOMENDASI/SARAN</th>
                    <th className="border border-gray-300 p-2" colSpan={2}>NILAI REKOMENDASI Rp.</th>
                  ...
                  {Object.entries(groupedData).map(([spNumber, items], groupIndex) => {
                    return items.map((item, itemIndex) => (
                      <tr key={item.id_tlhp} className="hover:bg-gray-100 text-center align-middle">
                        ...
                        <td className="border border-gray-300 p-2">{item.nilai_rekomendasi}</td>
                        <td className="border border-gray-300 p-2">
                          {getNameKodeRekomendasi(item.id_kode_rekomendasi).split('.')[0]}
                        </td>
                        <td className="border border-gray-300 p-2">
