            ...
            <Table className="w-full">
              ...
              <tbody>
                <tr className="hover:bg-gray-100">
                  <td
                    className="border border-gray-300 p-2 text-center text-[11px]"
                    rowSpan={4}
                  >
                    1
                  </td>
                  <td
                    className="border border-gray-300 p-2 text-start text-[11px]"
                    rowSpan={4}
                  >
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Repudiandae minima ullam reiciendis.
                  </td>
                  <td
                    className="border border-gray-300 p-2 text-start text-[11px]"
                    rowSpan={4}
                  ...
                  {/* st */}
                  <td className="border border-gray-300 p-2 text-start text-[11px] whitespace-nowrap">
                    Lorem, ipsum.
                  </td>
